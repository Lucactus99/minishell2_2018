...
LIB_FILES       := get_next_line my_put_nbr my_putchar_err my_putchar my_putstr_err my_putstr my_str_isalpha my_strcat my_strcmp my_strcpy my_strncmp transform_2d my_getnbr
